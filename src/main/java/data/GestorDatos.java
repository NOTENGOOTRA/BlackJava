...
public class GestorDatos {
    public static Juego leerArchivoEstudiantes(Juego blackjava, String direccionArchivo) {
        String textoArchivo = "";
        ...
        try {
            ...
            while ((textoArchivo = br.readLine()) != null) {
                ...
                blackjava.getJugadores().add(new Jugador(data[0], data[1], data[2]));
            }
            br.close();
            fr.close();
        } catch (Exception e) {
    ...
    public static boolean registrarDatos(List objetos, String direccionArchivo) {
        try {
            File file = new File(direccionArchivo);
            if (Files.deleteIfExists(Paths.get("C:\\Users\\Jorge\\Documents\\" + direccionArchivo))) {
